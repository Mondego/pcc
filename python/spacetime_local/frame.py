...
class frame(object):
  ...
  def __register_app(self, app):
    ...
    (producing, tracking, getting, gettingsetting, deleting) = (
    ...
    self.__typemap["getting"] = getting
    ...
    all_types = tracking.union(producing).union(getting).union(gettingsetting).union(deleting)
