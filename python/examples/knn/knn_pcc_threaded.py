...
class knn(object):
    ...
    def euclideanDistance(fl1, fl2):
        return math.sqrt(pow((fl1.sepal_length - fl2.sepal_length), 2) + pow((fl1.sepal_width - fl2.sepal_width), 2) + pow((fl1.petal_length - fl2.petal_length), 2) + pow((fl1.petal_width - fl2.petal_width), 2))
